...
return [
    ...
    | worden door de validatieklasse. Sommige regels hebben meerdere versies,
    | zoals de grootte-regels. Voel je vrij om elk van deze berichten aan te passen.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Hier kun je veldnamen leesbaarder maken, zoals "e-mailadres" in plaats van "email".
    |
    */
